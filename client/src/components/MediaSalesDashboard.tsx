  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      const tasksRes = await fetch(
        `${import.meta.env.VITE_API_URL}/api/tasks/project/${mediaProject.gid}/filter?customFieldGid=${functionField.gid}&optionGid=${salesOption.gid}`,
        { credentials: 'include' }
      );
...
export default MediaSalesDashboard;
